...
- **C9**: docs/HEXA_UPSTREAM.md NOT modified (parallel BG/BC track territory —
  race condition risk per user directive). airgenome/doc/airgenome_gamebox_perf_remaining_family_inventory_track_bf_landed_2026_05_05.ai.md
...
- `airgenome/doc/airgenome_gamebox_perf_remaining_family_inventory_track_bf_landed_2026_05_05.ai.md` (Track BF) — direct predecessor for v2 cycle.
