...
- `airgenome/doc/airgenome_gamebox_perf_metal_extension_track_ap_landed_2026_05_04.ai.md` (Track AP) — c_metal_* family extension precedent.
- `airgenome/doc/airgenome_gamebox_perf_pe_extension_track_aq_landed_2026_05_04.ai.md` (Track AQ) — c_pe_* family extension precedent.
- `airgenome/doc/airgenome_gamebox_perf_oauth_install_extension_track_ar_landed_2026_05_04.ai.md` (Track AR) — c_install_* family extension precedent.
