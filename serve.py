#!/usr/bin/env python3
"""serve.py — tiny static server for the gamebox ARCHITECTURE tree viewer.

The domain-tree SSOT is ARCHITECTURE.json (parsed by AI/tools); humans read it
...
def main(argv):
    ...
    with socketserver.TCPServer(("127.0.0.1", port), Handler) as httpd:
        print("gamebox architecture viewer — serving %s" % ROOT)
        print("  %s" % url)
