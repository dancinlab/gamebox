...
- [ ] Tier-A port (full): the remaining stateful unit of i386_decode.c (i386_decode_one + opcode dispatch + i386_format_insn) → hexa, RUNEQ vs C over real PE .text corpus
