...
- predecessor handoff: `docs/airgenome_gamebox_perf_manjeom_aggregation_review_landed_2026_05_03.ai.md` (Track T — cleanest cycle posture mirror precedent)
...
- `docs/airgenome_gamebox_cross_tool_integration_design_landed_2026_05_04.ai.md` — handoff (NEW, this file)
...
- predecessor handoff: `docs/airgenome_gamebox_perf_manjeom_aggregation_review_landed_2026_05_03.ai.md`
- predecessor marker: `state/markers/airgenome_gamebox_perf_manjeom_aggregation_review_landed.marker`
