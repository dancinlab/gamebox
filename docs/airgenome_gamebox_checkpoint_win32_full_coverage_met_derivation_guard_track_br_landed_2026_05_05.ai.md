...
- `docs/airgenome_gamebox_checkpoint_win32_full_coverage_met_derivation_guard_track_br_landed_2026_05_05.ai.md`
  (this handoff).
...
- Track AG — closure_orchestrator + checkpoint integration handoff
  (`docs/airgenome_gamebox_closure_orchestrator_checkpoint_integration_landed_2026_05_04.ai.md`
