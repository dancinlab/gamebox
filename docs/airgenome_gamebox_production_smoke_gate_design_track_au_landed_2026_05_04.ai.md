...
- predecessor handoff (가장 직접): `docs/airgenome_gamebox_hexa_upstream_retrofit_track_ao_landed_2026_05_04.ai.md` (Track AO 가장 최근 land), `docs/airgenome_gamebox_mk2_checkpoint_schema_design_landed_2026_05_04.ai.md` (Track AA, design-only with lock-in checklist 직접 mirror)
...
- `docs/airgenome_gamebox_production_smoke_gate_design_track_au_landed_2026_05_04.ai.md` — handoff (NEW, this file)
...
- predecessor handoff (가장 직접): `docs/airgenome_gamebox_hexa_upstream_retrofit_track_ao_landed_2026_05_04.ai.md` (Track AO, 가장 최근 land), `docs/airgenome_gamebox_mk2_checkpoint_schema_design_landed_2026_05_04.ai.md` (Track AA, design-only lock-in checklist 직접 mirror)
