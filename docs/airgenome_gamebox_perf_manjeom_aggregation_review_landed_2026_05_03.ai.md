...
- predecessor handoff: `docs/airgenome_gamebox_battlenet_bypass_own1_disambiguation_landed_2026_05_03.ai.md` (Track-P, BG-AGB rank B+C unblock 측 perf_manjeom 측 unblock 명시)
...
- `docs/airgenome_gamebox_perf_manjeom_aggregation_review_landed_2026_05_03.ai.md` — handoff (NEW, this file)
...
- predecessor handoff: `docs/airgenome_gamebox_battlenet_bypass_own1_disambiguation_landed_2026_05_03.ai.md`
- predecessor marker: `state/markers/airgenome_gamebox_battlenet_bypass_own1_disambiguation_landed.marker`
